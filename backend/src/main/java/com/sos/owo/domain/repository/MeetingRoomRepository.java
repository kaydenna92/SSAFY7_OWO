...
public class MeetingRoomRepository {
    ...
    public List<MeetingRoom> findMeetingRoomList(Mode mode) {
        List<MeetingRoom> meetingRoomList = em.createQuery("select m from MeetingRoom m where m.mode = :mode and m.status = :status ORDER BY m.openDate ASC", MeetingRoom.class)
